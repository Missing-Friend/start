...
const scenes = {
  ...
  'collectPiecesPark': {
    ...
    onEnter: () => {
      ...
      addPlace("Josh's House"); // Ensure Josh's House is unlocked if not already
    }
  },
  ...
  // Talking to family about page pieces (only available after diary ripped page found)
  'talkKaylee': {
    character: 'Kaylee',
    location: 'Josh\'s House',
